...
import { sendResetEmail, sendResetSuccessEmail, sendVerificationEmail } from "../mailtrap/emails.js"
...
export const verifyEmail = async (req, res) => {
	...
	try {
		...
		if (!user) {
			return res.status(400).json({ success: false, message: "Invalid or expired verification code, try signing up again" });
		}
...
export const signup = async (req, res) => {
    ...
    try {
        ...
        const verificationToken = Math.floor(99999 + Math.random() * 900000).toString()
